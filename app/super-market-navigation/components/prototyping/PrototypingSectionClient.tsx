...
function DigitalProcessStepper({ galleries }: { galleries: PrototypingGalleryBundle }) {
  ...
  return (
    <div className="proto-digital">
      <div className="proto-digital__stepper" role="tablist" aria-label="Digital prototype process">
        {DIGITAL_STEPS.map((s, i) => (
          <Fragment key={s.id}>
            {i > 0 && (
              <span className="proto-digital__between" aria-hidden="true">
                →
              </span>
            )}
            <button
              ...
              className={`proto-digital__step${i === stepIndex ? ' proto-digital__step--active' : ''}`}
...
export function PrototypingSectionClient({ galleries }: { galleries: PrototypingGalleryBundle }) {
  const [active, setActive] = useState<ProtoId | null>(null);
          ...
          <div className="proto-expanded__inner">
            <div className="proto-expanded__head">
              <div className="proto-expanded__titles">
                <h3 className="proto-expanded__heading h4">
              ...
              <button
                type="button"
                className="proto-expanded__close"
            ...
            <div className="proto-expanded__body">
              ...
              {active === 'spatial' && (
                <div className="proto-spatial">
                  ...
                  <p className="paragraph-new">
                    ...
                    miniature supermarket. Boxes stood in for shelves, a small figurine represented the
                    shopper, and the items on their list were placed inside the boxes. When the app said
                    &quot;move forward,&quot; the tester moved their figurine. When it said &quot;get item from
                    shelf,&quot; they opened the box and added the item to a small basket.
                  </p>
                  <p className="paragraph-new">
                    It sounds simple, and it was. That was the point. We could have taken testers into an
                    actual supermarket, but at this stage we needed to run tests quickly with multiple
                    participants and observe how they interpreted the app&apos;s directions in a spatial
                    context. The model let us do that in a controlled setting where we could watch
                    decision-making happen in real time without the noise and unpredictability of a live store.
                  </p>
                  <PublicFolderLightboxGalleryClient
              ...
              {active === 'physical' && (
                <div className="proto-physical">
                  <p className="paragraph-new">
                    Part of our university brief required a physical prototype component. We designed a
                    shopping basket with a moveable divider: the app would analyse your list and tell you how
                    to section your basket (for example, &quot;move the divider here, 60% of your items are
                    vegetables&quot;). The idea was to make purchasing categories physically visible, helping
                    users notice when they were adding unplanned items.
                  </p>
                  <p className="paragraph-new">
                    The first version was rough. Cardboard, masking tape, a green divider labelled
                    &quot;VEG.&quot; It was functional enough to put in front of testers and ask whether the
                    concept made sense.
                  </p>
                  ...
                  <p className="paragraph-new">
                    ...
                    into the basket. This made the interaction feel more tangible and gave us clearer feedback
                    on whether the categorisation logic was intuitive.
                  </p>
                  <p className="paragraph-new">
                    Ultimately, the basket system was dropped after user testing showed it added complexity
                    without enough benefit. The app&apos;s digital list and post-shop report already addressed
                    impulse buying more effectively. That decision is covered in the next section.
                  </p>
                  <PublicFolderLightboxGalleryClient
