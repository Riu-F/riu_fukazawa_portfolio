...
export default function AiOutcome() {
  ...
  return (
    <section className="default-section">
      ...
      <div className="default-container w-container">
        <div className="w-layout-grid persona-table">
          {/* --- Dewi column 1 --- */}
          <div className="table-divider-columns">
          ...
          {/* --- Harold & Margaret column 1 (no-boarder = right border) --- */}
          <div className="table-divider-columns no-boarder">
            <ul role="list" className="paragraph-new">
